...
export default class Popover extends Component {
  ...
  buildProps() {
    let {style, arrow, paddingCorner, headerStyle, arrowStyle, contentStyle, popoverStyle, arrowResetSize, ...others} = this.props;
    ...
    arrowSize=arrowResetSize?arrowResetSize:arrowSize
